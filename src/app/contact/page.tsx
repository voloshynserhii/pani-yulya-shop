            ...
            <div className="space-y-6 text-zinc-700 dark:text-zinc-300">
              <div className="p-6 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800">
                ...
                <ul className="space-y-3">
                  <li>
                    <span className="font-medium block text-zinc-900 dark:text-zinc-100">Повне найменування:</span>
                    ФОП Колодєєва Юлія Михаїлівна
                  </li>
                  <li>
                    <span className="font-medium block text-zinc-900 dark:text-zinc-100">ІПН:</span>
                    3425312660
                  </li>
                  <li>
                    <span className="font-medium block text-zinc-900 dark:text-zinc-100">Юридична адреса:</span>
              ...
              <div className="p-6 bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800">
                ...
                <ul className="space-y-3">
                  <li>
                    <span className="font-medium block text-zinc-900 dark:text-zinc-100">Email:</span>
